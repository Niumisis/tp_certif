...
--
-- Client: localhost
-- Généré le: Jeu 13 Décembre 2012 à 15:32
...
--
-- Contraintes pour la table `tp_questions`
--
ALTER TABLE `tp_questions`
  ADD CONSTRAINT `fk_qestions` FOREIGN KEY (`id_questions`) REFERENCES `tp_liste_questions` (`lst_ques_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
